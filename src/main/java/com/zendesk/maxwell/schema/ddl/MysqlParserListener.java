...
public class MysqlParserListener extends mysqlBaseListener {
	...
	@Override public void exitAlter_table(Alter_tableContext ctx) {
	...
	@Override
	public void exitAdd_column_parens(Add_column_parensContext ctx) {
	...
	@Override
	public void exitChange_column(Change_columnContext ctx) {
	...
	@Override
	public void exitModify_column(Modify_columnContext ctx) {
		ColumnDef c = this.columnDefs.removeFirst();
	...
	@Override
	public void exitDrop_column(Drop_columnContext ctx) {
		alterStatement().columnMods.add(new RemoveColumnMod(unquote(ctx.old_col_name().getText())));
	}
	@Override
	public void exitCol_position(Col_positionContext ctx) {
	...
	@Override
	public void exitConvert_to_character_set(Convert_to_character_setContext ctx) {
		alterStatement().convertCharset = unquote_literal(ctx.charset_name().getText());
	}

	@Override
	public void exitDefault_character_set(Default_character_setContext ctx) {
	...
	@Override
	public void exitDrop_table(Drop_tableContext ctx) {
	...
	@Override
	public void exitIndex_type_pk(Index_type_pkContext ctx) {
	...
	@Override public void exitDrop_primary_key(Drop_primary_keyContext ctx) {
		this.pkColumns = new ArrayList<>();
	}
