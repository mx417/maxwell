...
public class RowMapBufferTest extends TestWithNameLogging {
	...
	public void TestOverflowToDisk() throws Exception {
		...
		RowMap r;
		buffer.add(new RowMap("insert", "foo", "bar", 1000L, -1L, new ArrayList<String>(), new Position(new BinlogPosition(3, "mysql.1"), 0L)));
		buffer.add(new RowMap("insert", "foo", "bar", 2000L, -1L, new ArrayList<String>(), new Position(new BinlogPosition(3, "mysql.1"), 0L)));
		buffer.add(new RowMap("insert", "foo", "bar", 3000L, -1L, new ArrayList<String>(), new Position(new BinlogPosition(3, "mysql.1"), 0L)));
